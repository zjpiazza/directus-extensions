...
const handleNavigate = () => { if (props.data.targetWorkflowId) emit('navigate', props.data.targetWorkflowId); };
</script>
...
.node-icon { font-size: 16px; flex-shrink: 0; color: #ffffff; }
...
.navigate-btn { background: none; border: none; cursor: pointer; padding: 2px; border-radius: 2px; font-size: 12px; opacity: 0.7; transition: opacity 0.2s ease; }
.navigate-btn:hover { opacity: 1; background: rgba(51,65,85,0.12); }

.pentagon-shape:hover { transform: translateY(-2px); background: #334155; border-color: #334155; }
</style>
